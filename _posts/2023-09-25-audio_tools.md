...
I mostly listen to my music via [cmus](https://en.wikipedia.org/wiki/Cmus). For the curious, my configurations begin in [$OSAB/nodes-set/jo-0.sh](https://github.com/harriott/OS-ArchBuilds/blob/master/nodes-set/jo-0.sh).
