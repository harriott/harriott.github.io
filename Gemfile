...
# When you want to use a different version, change it below, save the file and run `bundle install`. Run Jekyll with `bundle exec`, like so:  bundle exec jekyll serve
...
gem "jekyll-remote-theme"  # to be able to use the latest version of minima theme - JH
gem 'jekyll-seo-tag'  # JH
